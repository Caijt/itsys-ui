...
<script>
	import list from '@/components/xs/report/list'
	import summaryDialog from '@/components/xs/report/summary/listDialog'
	import formDialog from '@/components/xs/report/formDialog'
	import summaryFormDialog from '@/components/xs/report/summary/formDialog'
	import summaryList from '@/components/xs/report/summary/list'
	...
	export default {
		...
		methods:{
			...
			openSummaryDialog(){
				this.$refs.summaryDialog.open({ isXsNew:1 })
			},
			createRecord(){
