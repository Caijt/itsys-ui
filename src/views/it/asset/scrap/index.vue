<template>
    <div>
        <div style="margin:10px 0px">
            <el-button-group>
                <el-button type="primary" @click="create" icon="el-icon-edit">创建报废记录</el-button>
            </el-button-group>
        </div>
        <list ref="list">
...
<script>
import list from "@/components/it/asset/scrap/list";
import editDialog from "@/components/it/asset/scrap/editDialog";
