<template>
	<div>
		<el-alert
	    title="根据查询条件对开票记录进行统计开票，合计得累计开票金额和开票数量"
	    type="success"
	    :closable="false">
	  </el-alert>
		...
		<div slot='button' style='margin-bottom: 10px'>
			<el-button @click='exportExcel' size='small'>导出Excel</el-button>
		</div>
		<invoice-record-list size='small' ref='invoiceRecordList' show-more @loaded='getTotal' >
