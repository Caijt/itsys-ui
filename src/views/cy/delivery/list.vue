<template>
	<div>
		<el-alert
	    title="查询发货记录列表，在当前页面可以创建发货记录及记录的更新、删除"
	    type="warning" 
	    :closable="false"
  	...
  	<el-row>
  		<el-col :span='8'>
  			<el-tooltip content='该按钮功能未开发' v-if='false'> 
	  			<el-button type='primary' size='small'>发货登记</el-button>
	  		</el-tooltip>
  			<el-popover>
  				<el-alert
				    title="还未登记发货记录的项目列表"
  				...
  				<el-table 
		    		...
		    		<el-table-column type='expand' width='20'>
						...
						<el-table-column label='操作' width='50'>
							<template slot-scope='scope'>
								<el-button size='mini' type='text' @click='createOrderByTodo(scope)'>发货</el-button>
							</template>
						</el-table-column>
					</el-table>
								...
								<el-row :gutter='10'>
									...
									<el-col :span='12'>
										<el-form-item label='发货内容' prop='delivery_content'>
											<el-input v-model='queryParams.delivery_content' clearable></el-input>
										</el-form-item>
									</el-col>
									<el-col :span='12' v-if='false'>
										<el-form-item label='入库面积' prop='order_days'>
											<el-col :span="11">
												<el-form-item prop='order_days_min'>
									      	<el-input v-model='queryParams.order_days_min' placeholder='最小值' clearable></el-input>
									    	</el-form-item>
									    </el-col>
									    <el-col class="line" :span="2">-</el-col>
									    <el-col :span="11">
									    	<el-form-item prop='order_days.max'>
									      	<el-input v-model='queryParams.order_days.max' placeholder='最大值' clearable></el-input>
									      </el-form-item>
									    </el-col>
										</el-form-item>
									</el-col>
									<el-col :span='12' v-if='false'>
										<el-form-item label='发货面积' prop='order_days'>
											<el-col :span="11">
												<el-form-item prop='order_days_min'>
									      	<el-input v-model='queryParams.order_days_min' placeholder='面积下限' clearable></el-input>
									    	</el-form-item>
									    </el-col>
									    <el-col class="line" :span="2">-</el-col>
									    <el-col :span="11">
									    	<el-form-item prop='order_days.max'>
									      	<el-input v-model='queryParams.order_days.max' placeholder='面积上限' clearable></el-input>
									      </el-form-item>
									    </el-col>
										</el-form-item>
									</el-col>
									<el-col :span='12' v-if='false'>
										<el-form-item label='发货进度' prop='order_days'>
											<el-col :span="11">
												<el-form-item prop='order_days_min'>
		...
		<el-table 
  		...
  		max-height='400'>
			...
			<el-table-column label='操作' fixed='right' align='center' width='130'>
				<template slot-scope='scope'>
					<el-tooltip content='在该项目创建新发货记录' placement='left'>
						<el-button  size='mini' type='text' @click='createOrder(scope)'>发货</el-button>			 
					</el-tooltip>
    ...
    <el-dialog  
    	:title='isFormEdit?"编辑发货记录":"创建发货记录"' 
    	:visible.sync='dialogShow' @open='openDialog'
    	top='2vh'>
			<el-form :model='form' :rules='formRules' ref='form' size='small' label-width='100px' status-icon>
				<el-row :gutter='20'>
					<el-col :span='24'>
				...
				<el-row :gutter='20'>					
					<el-col :span='12'>
						<el-form-item label='首次入库日期' prop='first_storage_date'>
							<el-date-picker v-model='form.first_storage_date' value-format='yyyy-MM-dd' style='width: 100%'></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span='12'>
						<el-form-item label='首次发货日期' prop='first_delivery_date'>
							<el-date-picker v-model='form.first_delivery_date' value-format='yyyy-MM-dd' style='width: 100%'></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span='12'>
						<el-form-item label='最近入库日期' prop='storage_date'>
							<el-date-picker v-model='form.storage_date' value-format='yyyy-MM-dd' style='width: 100%'></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span='12'>
						<el-form-item label='最近发货日期' prop='delivery_date'>
							<el-date-picker v-model='form.delivery_date' value-format='yyyy-MM-dd' style='width: 100%'></el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :span='12'>
						<el-form-item label='累计入库面积' prop='storage_area'>
					...
					<el-col :span='12'>
						<el-form-item label='累计发货面积' prop='delivery_area'>
					...
					<el-col :span='24'>
						<el-form-item label='发货内容描述' prop='delivery_content'>
							<el-input v-model='form.delivery_content' type='textarea' :rows='4'></el-input>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
			<span slot="footer">
		    <el-tooltip content='将发货记录情况提交到项目中更新项目信息'>
		    	<el-button 
		    		@click="save({isSubmit:true})" 
		    		type="primary" 
		    		:loading='formLoading'>
		    		{{isFormEdit?"更新并提交":"创建并提交"}}
		    	</el-button>
		    </el-tooltip>
...
export default {
	data(){
		return {
			...
			formRules:{
				payment_unit:[{ required:true, message:'请填写回款单位' }],
	...
	methods:{		
		...
		editOrder({row}){
			let r = {
				...
				id:row.id,
				first_storage_date:row.first_storage_date,
		...
		getTodoProject(){
			...
			deliveryApi.getTodoProjectList().then(res=>{
