<template>
	<div>
		<div style='margin:10px 0px'>
			<el-button-group>
				<el-button type='primary' @click='create' icon='el-icon-edit'>创建工厂</el-button>
			</el-button-group>
		</div>
...
<script>
import list from '@/components/sys/factory/list'
import editDialog from '@/components/sys/factory/editDialog'
