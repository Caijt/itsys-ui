<template>
	<div>
		<div style='margin:10px 0px'>
			<el-button type='primary' @click='create'>对账单录入</el-button>
...
<script>
	import paymentList from '@/components/yyzx/loanSettlement/list'
	import editDialog from '@/components/yyzx/loanSettlement/edit/dialog'
	import info from '@/components/yyzx/loanSettlement/details'
	import importDialog from '@/components/yyzx/loanSettlement/edit/import'
