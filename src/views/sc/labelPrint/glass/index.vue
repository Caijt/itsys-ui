<template>
	<div>
		...
		<el-tabs v-model='tabName' @tab-click='reload'>
			...
			<el-tab-pane label='玻璃标签明细' name='certificate'>
...
<script>
	import list from '@/components/sc/labelPrint/glass/list'
	import orderFormDialog from '@/components/sc/labelPrint/glass/orderFormDialog'
	import orderList from '@/components/sc/labelPrint/glass/orderList'
	import labelDialog from '@/components/sc/labelPrint/glass/labelDialog'
