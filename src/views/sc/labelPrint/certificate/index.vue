<template>
	<div>
		...
		<el-tabs v-model='tabName' @tab-click='reload'>
			...
			<el-tab-pane label='合格证明细' name='certificate'>
...
<script>
	import list from '@/components/sc/labelPrint/certificate/list'
	import orderFormDialog from '@/components/sc/labelPrint/certificate/orderFormDialog'
	import orderList from '@/components/sc/labelPrint/certificate/orderList'
	import labelDialog from '@/components/sc/labelPrint/certificate/labelDialog'
