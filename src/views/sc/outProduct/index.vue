	...
	<div>
	   ...
	   />
		...
		<el-tabs v-model='tabName' @tab-click='reload'>
			...
			<el-tab-pane label='外协生产明细' name='list'>
...
<script>
	...
	import summaryFormDialog from '@/components/sc/outProduct/summary/formDialog'
	import summaryList from '@/components/sc/outProduct/summary/list'
		...
		methods:{
			...
			createBySummary({ row }){
				let data = this.$commonJs.obj.copyByKey(row,[
					...
					'no_product_area','order_date','project_id','project_name','out_area','sc_out_is_finish',
