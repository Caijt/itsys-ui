	...
	<div>
		...
		<el-table 
			...
			<el-table-column 
				...
				align='center' 
				width='35' />
			<el-table-column prop='name' label='工厂名称' min-width='120' show-overflow-tooltip/>
			...
			<el-table-column prop='address' label='工厂地址' min-width='120' show-overflow-tooltip/>	
			<el-table-column 
...
<script>
import api from '@/api/sys/factory'
