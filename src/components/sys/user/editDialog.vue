          ...
          <el-row :gutter="10">
            <el-col :span="12">
              <el-form-item label="登录用户" prop="login_name">
                <el-input v-model="form.login_name" placeholder="此用户登录系统的登录名"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="用户名称" prop="name">
                <el-input v-model="form.name" placeholder="此用户的名称"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12" v-if="isEdit">
              <el-form-item label="修改密码" prop="change_pwd">
                <el-switch v-model="form.change_pwd"/>
              </el-form-item>
            </el-col>
            <el-col :span="12" v-if="!isEdit||form.change_pwd">
              <el-form-item label="登录密码" prop="pwd">
                <el-input v-model="form.pwd" type="password" placeholder="用户登录密码"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-form-item label="企业号ID" prop="qywx_user">
            <el-input v-model="form.qywx_user" placeholder></el-input>
          </el-form-item>
          <el-row :gutter="10">
            <el-col :span="12">
