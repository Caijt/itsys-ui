            ...
            <div v-loading="loading">
                ...
                >
                    ...
                    <el-form-item label="员工姓名" prop="name">
                        <el-input v-model="form.name" placeholder style="width:30%"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="工号" prop="no">
                        <el-input v-model="form.no" placeholder style="width:30%"></el-input>
                    </el-form-item>
                    <el-form-item label="邮箱" prop="mail">
                        <el-input v-model="form.mail" placeholder style="width:30%"></el-input>
                    </el-form-item>
...
export default {
    ...
    data() {
        return {
            ...
            form: { ...formInit },
            rules: {
                name: [{ required: true, message: "请填写员工名称" }],
