...
<template>
  <div>
    ...
    <el-table 
      ...
      <el-table-column prop='color_no' fixed label='色板色号' width='110' sortable='custom' show-overflow-tooltip />
      <el-table-column prop='no' label='色板打样编号' width='110' show-overflow-tooltip />
      ...
      <el-table-column prop='confirm_time' label='确认时间' sortable='custom' width='140'>
...
export default {
  ...
  methods:{
    ...
    getData() {
      this.loading=true
      colorSampleApi.getColorList(this.requestParams).then(res=>{
