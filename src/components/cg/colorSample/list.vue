...
<template>
  <div>
    ...
    <el-table 
      ...
      <el-table-column prop='is_finish' label='打板完成' align='center' width='80'>
        <template slot-scope='{row}'>
          <el-tag size='mini' type='success' v-if='row.is_finish==1'>已完成</el-tag>
          <el-tag size='mini' v-else>打板中</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop='supplier' label='打板厂家' width='110' show-overflow-tooltip />
      <el-table-column prop='finish_date' label='完成日期' width='130' sortable='custom'>
        <template slot-scope='{row}'>
          {{row.finish_date}}
          <el-tag size='mini' v-if='row.is_finish==0'>预计</el-tag>
        </template>
      </el-table-column>
      <el-table-column prop='remarks' label='单板说明' width='110' show-overflow-tooltip />
      <el-table-column prop='file_no' label='归档编号' width='110' show-overflow-tooltip />
      <el-table-column prop='file_date' label='归档日期' width='110' sortable='custom'show-overflow-tooltip />
      <el-table-column prop='file_remarks' label='归档说明' width='110' show-overflow-tooltip />
      ...
      <el-table-column prop='submit_time' label='提交时间' sortable='custom' width='140'>
        <template slot-scope='{row}'>
