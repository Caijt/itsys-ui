	...
	<div>
		...
		<el-table 
          ...
          <span >{{ row.order_no }}</span>
			...
			<el-table-column prop='no' label='窗号' show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop='type' label='生产类型' width='80' show-overflow-tooltip></el-table-column>
...
export default {
	...
	methods:{
		...
		getData() {
			this.loading=true
			windowApi.getList(this.requestParams).then(res=>{
