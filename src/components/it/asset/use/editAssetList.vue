    ...
    <div>
        <el-form :model="form" ref="form" class="c-form-mini" status-icon>
            ...
            >
                ...
                <el-table-column prop="remain" fixed="right" sortable label="库存量" width="100"></el-table-column>
                <el-table-column prop="payment_price" label="领用数量" width="100" fixed="right">
                    <template slot-scope="{row}">
                        ...
                        >
                            <el-input v-model.number="row.use_amount" :placeholder="row.remain"></el-input>
                        </el-form-item>
                    </template>
                </el-table-column>
                <!-- slot[column] -->
