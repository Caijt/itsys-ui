    ...
    <div>
                        ...
                        <el-row style="width:300px">
                            <el-col :span="11">
                                <el-form-item prop="inbound_date_begin">
                                    <el-date-picker
                                        v-model="queryParams.inbound_date_begin"
                                        placeholder="开始日期"
                            ...
                            <el-col :span="11">
                                <el-form-item prop="inbound_date_end">
                                    <el-date-picker
                                        v-model="queryParams.inbound_date_end"
                                        placeholder="结束日期"
                                        value-format="yyyy-MM-dd"
                                        style="width: 100%"
                                    ></el-date-picker>
        ...
        >
            ...
            <el-table-column
                ...
                label="交还日期"
            />
            <el-table-column prop="dep_name" width="100" label="交还部门" show-overflow-tooltip/>
            <el-table-column prop="employee_name" width="90" label="交还人" show-overflow-tooltip/>
            <el-table-column
                v-if="!hideRecordFields"
                prop="remarks"
                label="交还备注"
            ...
            <el-table-column prop="amount" align="right" label="交还数量" sortable="custom" width="100"></el-table-column>
            <el-table-column v-if="!hideRecordFields" prop="create_user_name" label="录入员"/>
            <el-table-column
                v-if="!hideRecordFields"
                prop="submit_time"
                width="120"
...
<script>
import assetApi from "@/api/it/assetUseRecordItem";
