    ...
    <div>
        ...
        >
            ...
            <div v-loading="loading">
                <el-form ref="form" label-width="85px" size="mini" class="c-form-text">
                    ...
                    <el-row :gutter="10">
                        <el-col :span="8">
                            <el-form-item label="入库日期">
                                <span>{{form.inbound_date | formatToDate }}</span>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="8">
                            <el-form-item label="供应商">
                                <span
                                    class="c-link no-line"
                                    @click="openSupplierDetails(form)"
                                >{{form.supplier_name}}</span>
                            </el-form-item>
                        </el-col>
                        <el-col :span="8">
                ...
                <el-tabs v-model="tabName">
                    <el-tab-pane label="领用状态" name="useStatus">
                        <asset-use-status-list
                            in-dialog
                            hide-query
                            no-page
                            hide-asset-fields
                            ref="assetUseStatusList"
                        />
                    </el-tab-pane>
                    <el-tab-pane label="领用记录" name="use">
                        <asset-use-return-list
                            in-dialog
                            sort-prop="submit_time"
                            hide-asset-fields
                            hide-query
                            no-page
                            ref="assetUseReturnList"
                        />
                    </el-tab-pane>
...
export default {
    ...
    created() {
        this.$options.components.assetUseStatusList = () =>
            import("./useStatus/list");
        this.$options.components.assetUseReturnList = () =>
            import("./useReturn/list");
        this.$options.components.assetRepairList = () =>
            import("./repair/list");
