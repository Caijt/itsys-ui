    ...
    <div>
        ...
        >
            <div v-loading="loading">
                ...
                >
                    ...
                    <el-form-item label="资产型号" prop="model">
                        <el-input v-model="form.model" placeholder="资产具体型号"></el-input>
                    </el-form-item>
                    <el-form-item label="资产类型" prop="type_id">
                        ...
                        >
                            <i
                                ...
                                @click.stop="form.type_name='';form.type_id=null"
                            ></i>
                            <el-button slot="append" @click.stop="createType">创建</el-button>
                        </el-input>
                    </el-form-item>
                    <el-form-item label="标识号" prop="diy_no">
                        <el-input v-model="form.diy_no" placeholder="企业内部一些自定义的标识号"></el-input>
                    </el-form-item>
                    <el-row :gutter="10">
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <el-form-item label="入库数量" prop="amount">
                                <el-input v-model.number="form.amount" style="width: 150px"></el-input>
                            </el-form-item>
                        </el-col>
                    </el-row>
                    <el-row :gutter="10">
                        <el-col :span="12">
                            <el-form-item label="库存预警" prop="is_stock_warning">
                                <el-tooltip content="是否关联库存预警种类">
                                    <el-switch v-model="form.is_stock_warning"/>
                                </el-tooltip>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12" v-if="form.is_stock_warning">
                            <el-form-item label="库存种类" prop="stock_warning_id">
                                <el-input
                                    v-model="form.stock_warning_name"
                                    placeholder="点击选择"
                                    readonly
                                    @click.native="openSelectStockWarningDialog"
                                >
                                    <i
                                        style="cursor: pointer;"
                                        ...
                                        slot="suffix"
                                        class="el-input__icon el-icon-close"
                                        @click.stop="form.stock_warning_name='';form.stock_warning_id=null"
                                    ></i>
                                </el-input>
                            </el-form-item>
                        </el-col>
                    ...
                    <el-form-item label="来源方式" prop="source">
                        <el-autocomplete
                            v-model="form.source"
                            clearable
                            :fetch-suggestions="getPropList('source')"
                            style="width: 150px"
                        ></el-autocomplete>
                    ...
                    <el-form-item label="序列号" prop="sn">
                        <el-input v-model="form.sn" placeholder="资产出厂编号" style="width: 150px"></el-input>
            ...
            <div slot="footer" v-loading="loading">
                <el-button type="primary" @click="btnSave(0)" :loading="loading">保存</el-button>
        ...
        <stock-warning-dialog
            :in-dialog="inDialog"
            show-select
            ref="stockWarningDialog"
            @select="selectStockWarning"
        />
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        ...
        assign(data) {
            ...
            this.form.is_stock_warning = this.form.stock_warning_id
                ? true
                : false;
            return this;
        },
        ...
        getPropList(prop) {
            return (keyword, callback) => {
                assetApi.getPropList({ prop, keyword }).then(res => {
