    ...
    >
            ...
            >
                ...
                <div class="_it-asset-label-content">
                    ...
                    <div class="_it-asset-label-content-text">
                        <div class="_it-asset-label-content-text-title">IT资产</div>
        ...
        <span slot="footer">
            ...
            <el-button
                type="primary"
                @click="print"
                v-loading="getImgPercentage!=100"
                v-show="list.length>0"
            >打 印</el-button>
...
export default {
    ...
    computed: {
        ...
        getImgPercentage() {
            return this.$commonJs.getProgressPercentage(
                this.imgLoadCount / this.list.length
            );
        }
    },
    methods: {
