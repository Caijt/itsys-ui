      ...
      <div v-loading="loading">
        ...
        >
          ...
          <el-form-item label="合同编号" prop="no">
            <el-input v-model="form.no" placeholder style="width:150px"></el-input>
          </el-form-item>
          ...
          <el-form-item label="签订日期" prop="sign_date">
            <el-date-picker v-model="form.sign_date" value-format="yyyy-MM-dd" style="width:150px"/>
          </el-form-item>
          ...
          <el-form-item label="失效日期" prop="end_date">
            <el-date-picker v-model="form.end_date" value-format="yyyy-MM-dd" style="width:150px"/>
          </el-form-item>
          <el-form-item label="失效提醒" prop="is_remind">
            <el-switch v-model="form.is_remind"/>
          ...
          <el-form-item label="附件" prop="remarks">
            <attach-upload
              ...
              @uploaded="uploaded"
            ></attach-upload>
            <attach-list ref="attachList" :del-url="delAttachUrl" show-del></attach-list>
          </el-form-item>
        </el-form>
      </div>
