	...
	<div>
		<el-row :gutter='10' class='_info' v-loading='summaryLoading'>
			...
			<el-col :span='12'>
				<el-row :gutter='5'>
					<el-col :span='6'>
				<el-card shadow='hover'  @click.native='$router.push("/cw/arrears/customer")'>
					<div class='_card'>
						<div class='_main'>{{ arrearsCustomerTotal}}</div>
						<div class='_text'>应收客户</div>
					</div>
				</el-card>
			</el-col>
			<el-col :span='6' >
				<el-card  shadow='hover' @click.native='$router.push("/cw/arrears/project")'>
					<div class='_card'>
						<div class='_main'>{{ arrearsProjectTotal }}</div>
						<div class='_text'>应收项目</div>
					</div>
				</el-card>
			</el-col>
			<el-col :span='6' >
				<el-card shadow='hover' @click.native='$router.push("/cw/arrears/company")'>
					<div class='_card'>
						<div class='_main'>{{ arrearsCompanyTotal }}</div>
						<div class='_text'>应收公司</div>
					</div>
				</el-card>
			</el-col>
			<el-col :span='6' >
				<el-card shadow='hover' @click.native='$router.push("/cw/arrears/contract")'>
					<div class='_card'>
						<div class='_main'>{{ arrearsContractTotal }}</div>
						<div class='_text'>应收合同</div>
					</div>
				</el-card>
			</el-col>
				</el-row>
