...
<template>
  <div>
    ...
    <div style='margin-bottom:2px' v-show='!hideQuery'>
      ...
      <el-form ref='formQuery' :model='queryParams' label-width='68px' 
        ...
        <el-form-item prop='isArrears'>
          <el-tooltip content='只显示在途物资不等于0的公司'>
            <el-checkbox 
    ...
    <el-table 
      ...
      <el-table-column prop='arrears_customer_total' label='在途客户' sortable='custom' width='100' align='center'>
        <template slot-scope='{row}'>
      ...
      <el-table-column prop='cw_last_invoice_date' label='最近开票日期' sortable='custom' width='120' />
       <el-table-column prop='arrears_price' fixed='right' align='right' sortable='custom' label='在途物资金额' width='130' >
        <template slot-scope='{row}'>
          ￥{{ row.arrears_price }}
        </template>
      </el-table-column>
