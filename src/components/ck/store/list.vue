	...
	<div>
		...
		<el-table 
          ...
          <span class='c-link' @click='openOrderInfo(row.order_id)'>{{ row.order_no }}</span>
			...
			<el-table-column prop='area_name' label='生产工厂' show-overflow-tooltip></el-table-column>
			...
			<el-table-column prop='xc_storage_date' label='型材入库日期' width='110' show-overflow-tooltip></el-table-column>
			<el-table-column prop='material_type' label='材料类别' width='110' show-overflow-tooltip></el-table-column>
			<el-table-column prop='material_status' label='材料状态' width='110' show-overflow-tooltip></el-table-column>
			<el-table-column prop='material_stock' label='材料库存情况' width='110' show-overflow-tooltip></el-table-column>
			<el-table-column prop='other_material_stock' label='非通用材料情况' width='110' show-overflow-tooltip></el-table-column>
			<el-table-column prop='hardware_storage_date' label='五金入库日期' width='110' show-overflow-tooltip></el-table-column>
			<el-table-column prop='hardware_status' label='五金材料状态' width='110' show-overflow-tooltip></el-table-column>
			<el-table-column prop='hardware_stock' label='五金库存情况' width='110' show-overflow-tooltip></el-table-column>
