...
<template>
  <div>
    ...
    <el-table 
      ...
      <el-table-column v-if='!hideCarFields' prop='car_no' label='车辆编号' width='130' show-overflow-tooltip />
      <el-table-column v-if='!hideCarFields' prop='project_name' label='项目名称' width='110' show-overflow-tooltip />
      ...
      <el-table-column prop='name' label='品名' min-width='110' show-overflow-tooltip />
      ...
      <el-table-column v-if='!hideEditFields' prop='create_user_name' label='录入员' />
