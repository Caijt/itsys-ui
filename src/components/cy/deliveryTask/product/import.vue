		...
		<el-dialog 
			...
			<div v-loading='loading'>
				<attach-upload 
					...
					ref='attachUpload'
					:url='attachUploadUrl'
					:params='{car_id:form.car_id}'/>
			</div>
			<span slot="footer">
		    <el-button type='primary' @click="upload" v-loading='loading'>导 入</el-button>
		    <el-button type='success' @click="down('cy_delivery_task_product_import_template.xlsx')" >下载导入模板</el-button>
...
<script>
	...
	export default {
		...
		data(){			
			return {
				attachUploadUrl:productApi.excelUploadUrl,
				updated:false,
				show:false,
				buttonLoading:false,
				data:null,
