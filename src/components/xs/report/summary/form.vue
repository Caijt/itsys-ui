<template>
	<div v-loading='loading'>
				...
				<el-col :span='17' style='text-align: center'>
					<el-row>
						<el-col :span='6'>
							...
							<el-tooltip placement='left' :content='(form.xd_order_area_total||0)+"㎡（下单面积） / "+(form.project_area||0)+"㎡（项目面积）"'>
							<el-progress 
								type="circle" 
						...
						<el-col :span='6'>
							...
							<el-tooltip placement='left' :content='"￥"+form.cw_payment_price_total+"（回款金额） / ￥"+form.cw_invoice_price_total+"（开票金额）"'>
								<el-progress 
									type="circle" 
									:stroke-width='10' 
		...
		<divider title='销售计划报告列表'></divider>
		<el-alert
	    title="以最后提交的报告做为项目的销售计划报告，已提交的报告无法修改" 
...
<script>
	...
	import summaryDialog from '@/components/xs/report/summary/listDialog'
	import deliveryList from '@/components/xs/report/list'
	import formDialog from '@/components/xs/report/formDialog'
