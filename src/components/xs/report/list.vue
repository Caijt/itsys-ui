	...
	<div>
		...
		<div style='margin-bottom:3px'>
			...
			<el-form ref='formQuery' :model='queryParams' label-width='68px' 
				...
				<el-form-item label='下单描述' prop='order_content'>
					<el-input v-model='queryParams.order_content' clearable></el-input>
				</el-form-item>
				<el-form-item label='交货计划' prop='delivery_plan'>
					<el-input v-model='queryParams.delivery_plan' clearable></el-input>
				</el-form-item>
				<el-form-item label='回款计划' prop='return_plan'>
					<el-input v-model='queryParams.return_plan' clearable></el-input>
				</el-form-item>
				<!-- 更多条件 -->
		...
		<el-table 
          ...
          <span class='c-link' @click='openOrderInfo(row.project_id)'>{{ row.project_no }}</span>
			...
			<el-table-column prop='order_content' label='下单描述' show-overflow-tooltip></el-table-column>			
			<el-table-column prop='delivery_plan' label='交货计划' show-overflow-tooltip></el-table-column>			
			<el-table-column prop='return_plan' label='回款计划' show-overflow-tooltip></el-table-column>	
...
<script>
import productApi from '@/api/xs/report'
