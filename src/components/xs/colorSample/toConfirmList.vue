...
<template>
  <div>
    ...
    <el-table 
      ...
      <el-table-column prop='amount' label='色板数量' align='right' width='100' sortable='custom' />
      <el-table-column 
      ...
      <el-table-column prop='file_user_name' label='归档人' width='120' show-overflow-tooltip />
      ...
      <el-table-column prop='make_user_name' label='采购人' width='120' show-overflow-tooltip />
      ...
      <el-table-column prop='delivery_user_name' label='发出人' width='80' show-overflow-tooltip />
      <el-table-column prop='delivery_time' label='发出提交时间' width='120' sortable='custom' >
        <template slot-scope='{row}'>
...
export default {
  ...
  methods:{
    ...
    getData() {
      this.loading=true
      colorSampleApi.getToConfirmList(this.requestParams).then(res=>{
