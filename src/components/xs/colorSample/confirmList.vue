...
<template>
  <div>
    ...
    <el-table 
      ...
      <el-table-column prop='confirm_remarks' label='确认说明' width='120' show-overflow-tooltip />
      ...
      <el-table-column prop='confirm_user_name' label='确认人' width='120' show-overflow-tooltip />
...
export default {
  ...
  methods:{
    ...
    getData() {
      this.loading=true
      colorSampleApi.getConfirmList(this.requestParams).then(res=>{
    ...
    exportExcel(){
      colorSampleApi.exportConfirmExcel(this.requestParams)
    },
