<template>
	...
	<el-dialog 
				...
				<el-row :gutter='10' :class='{ "c-input-readonly":form.input_status!=0}'>
					...
					<el-col :span='8'>
						<el-form-item label='色板色号' prop='color_no'>
							<el-input v-model='form.color_no' :readonly='form.input_status!=0'>
							</el-input>
						</el-form-item>
					</el-col>
					<el-col :span='8'>
		...
		<span slot="footer">
		 	<el-button type='primary' size='small' @click='save(1)' :loading='loading' v-show='form.input_status==0'>提交申请</el-button>
	    <el-button size='small' @click='save(0)' :loading='loading' v-show='form.input_status==0'>保存</el-button>
